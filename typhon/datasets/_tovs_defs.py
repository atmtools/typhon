...
HIRS_header_dtypes = {}
HIRS_line_dtypes = {}
HIRS_data_vars_props = {} # for xarray.Dataset
...
# define how it shall be stored in xarray Dataset
_coding = {
    "shuffle": True,
    "zlib": True,
    "complevel": 4,
...
HIRS_count_to_temp["NOAA16"].update({'an_bptemp': array([  3.76275208e+02,  -4.53256111e+01,   3.57388902e+00,
 ...
 'fwcnttmp': array([[  3.01411987e+02,   6.55641407e-03,   8.40527719e-08,
...
HIRS_count_to_temp["NOAA17"].update({'an_bptemp': array([  3.92104492e+02,  -7.96604385e+01,   3.41925392e+01,
 ...
 'fwcnttmp': array([[  3.01412201e+02,   6.56620087e-03,   8.79867983e-08,
